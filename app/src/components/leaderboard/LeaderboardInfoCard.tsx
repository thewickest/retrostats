  ...
  return (
    <div className="flex flex-wrap text-center p-2
      ...
      <div className="flex max-sm:flex-auto max-sm:border-b-2 max-sm:border-black max-sm:w-full max-sm:pb-1">
        ...
        <div className="max-sm:flex-auto w-56 place-content-center sm:border-r-2 sm:border-black text-text font-heading">
          <p>{name}</p>
        </div>
      </div>
      <div className="flex flex-auto w-28 max-sm:w-full justify-around sm:justify-between max-sm:pt-1 sm:p-2 text-text">
